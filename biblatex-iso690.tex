...
This project is released under the GNU/GPL 3\footnote{\url{http://www.gnu.org/licenses/gpl.txt}} license.
...
Note that for correct support of localization functionality, the \t|babel| % really?
...
main document language, e.g. \t|en_IN| for English as used in India.
...
\begin{description}
  ...
  \item[thesisinfolast] whether or not to print information about a % Needs a better explanation!
  thesis (e.g. type, institution or supervisor) in the notes section
