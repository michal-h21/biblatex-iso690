...
\noindent
Example: command \cmd{cite\{knuth\}} outputs [1].
...
\begin{itemize}
  ...
  \noindent
  Example: command \cmd{textcite\{knuth\}} outputs
  \textcite{knuth}.
  ...
  \noindent
  Example: command \cmd{parencite\{knuth\}} outputs
  \parencite{knuth}.
\end{itemize}
...
\t|editoratype| field; it is the key that translates based on the localisation
strings.
For the patent type, we can use localisation strings as well, e.g.
\t|patenteu|.
\newline
