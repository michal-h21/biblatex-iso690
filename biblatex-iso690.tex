...
The entry type \t|thesis| and its aliasis \t|mastersthesis| and
\t|phdthesis| are available by default for thesis works. Use the
\t|type| field to specify the type of thesis -- localization
...
For other details regarding this type, please refer to \t|biblatex|
documentation.
